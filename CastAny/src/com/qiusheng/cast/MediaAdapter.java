...
public class MediaAdapter extends BaseAdapter {
    ...
    private void addVideos() {
        ...
        // my own media files
        mVideos.add(new CastMedia("Masha And The Bear HTTP", "http://qiushengxy.no-ip.info:8080/Videos/test.mp4"));
        mVideos.add(new CastMedia("Masha And The Bear SAMBA", "file://192.168.0.12/Videos/test.mp4"));
        mVideos.add(new CastMedia("ytimg swf", "http://s.ytimg.com/yts/swfbin/watch_as3-vfljqmUXI.swf"));
        mVideos.add(new CastMedia("youtube link", "http://www.youtube.com/v/ESua4zGyo2Y?version=3&amp;autohide=1"));
    }
